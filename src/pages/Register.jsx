...
function Register() {
    const imgStyle = 'lg:w-96 object-cover rounded-custom cursor-pointer transition ease-in-out hover:scale-10 duration-200 shadow-200';
    const divImgStyle = 'w-fit text-center lg:space-y-8 md:space-y-14';
    const h2style = 'text-3xl text-primary';
    return(
